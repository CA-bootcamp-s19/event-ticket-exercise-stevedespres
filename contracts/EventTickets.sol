...
contract EventTickets {
    ...
    */
    function getBuyerTicketCount(address buyer) view public
        returns (uint)
    {
    ...
    */
    function buyTickets(uint numberOfTickets) payable public
    {
        ...
        require(myEvent.isOpen, "Error : sale is not open");
        require(msg.value >= totalPayable, "Error : not enough value to pay tickets");
        require(numberOfTickets <= (myEvent.totalTickets - myEvent.sales), "Error : not enough tickets for sale");
